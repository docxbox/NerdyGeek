...
export function createDocsIntelligenceMcpServer() {
    ...
    server.registerTool("search_docs", {
        title: "Search Docs",
        description: "Retrieve version-aware, official documentation for a framework or library using automatic source discovery.",
        ...
        try {
            ...
            const result = await search_docs(packageJson
                ? {
                    query,
                    packageJson
                }
