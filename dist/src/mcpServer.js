...
import { diffResponseSchema, docsModeSchema, lockfileContextSchema, packageJsonSchema, scanResponseSchema, searchDocsResponseSchema } from "./types.js";
...
async function instrument(tool, fn) {
...
export function createDocsIntelligenceMcpServer() {
    ...
    server.registerTool("search_docs", {
        ...
        try {
            ...
            const result = await instrument("search_docs", () => search_docs({
                query,
                ...(mode !== undefined && { mode }),
    ...
    server.registerTool("diff_docs", {
        title: "Diff Docs",
        description: "Compare two versions of a framework or library and return structured new, deprecated, removed, and breaking changes.",
    ...
    server.registerTool("scan_deprecations", {
        ...
        description: "Scan a file's source code for deprecated or removed APIs based on official migration and deprecation docs.",
        ...
        try {
            ...
            const result = await instrument("scan_deprecations", () => scan_deprecations({
                fileContent,
                stack,
